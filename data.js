...
const GAME_DURATION_SECONDS = 100 * 60; // 100 分鐘
...
院方委託你們小組，在<strong>時限內</strong>重建出完整的診斷報告，藉此釐清 A19 口腔狀況急速惡化的真正原因。<br><br>
...
const STAGES = [
  ...
  },
  {
    ...
    background: `
      <p>牙齒可依型態與功能分成四大類：</p>
      <ul>
        <li><strong>門齒（切齒）</strong>：切端呈鑿狀，單根，負責切斷食物；下顎的中門齒通常是恆牙中最早萌發的門齒，比同側的側門齒更早長出</li>
        <li><strong>犬齒</strong>：牙尖尖銳呈單一尖峰，牙根是全口最長的，負責撕裂食物</li>
        <li><strong>小臼齒</strong>：咬合面通常有 2 個咬頭，介於犬齒與大臼齒之間</li>
        <li><strong>大臼齒</strong>：咬合面咬頭數最多（4–5 個），負責磨碎食物，第一大臼齒（六歲齒）通常是恆牙中最早萌發、體積最大的臼齒</li>
      </ul>
      <p>牙醫界常用 <strong>FDI 兩位數編號系統</strong>標示牙位：第一位數字代表「象限」，第二位數字代表「從正中線數來的牙位」。</p>
  ...
  },
  {
    ...
    background: `
      ...
      <ul>
        <li><strong>琺瑯質</strong>：人體最堅硬的組織，幾乎全由無機礦物質構成，無血管神經。</li>
        <li><strong>牙本質</strong>：位於琺瑯質內側，礦物質含量次之，內部有牙本質小管，可傳導冷熱刺激。</li>
        <li><strong>牙髓</strong>：牙齒中心的軟組織，含血管與神經，幾乎不含礦物質。</li>
        <li><strong>牙骨質</strong>：包覆牙根表面，讓牙周韌帶纖維附著，礦物質含量介於牙本質與軟組織之間。</li>
        <li><strong>牙周韌帶</strong>：連接牙根與齒槽骨的緻密結締組織，主要由膠原纖維構成，礦物質含量趨近於零。</li>
      </ul>
    `,
    task: `
      ...
      <p>依成分比例判斷 A–E 分別對應哪一種組織，再從中找出「礦物質含量呈現明顯梯度」的三種硬組織，依無機質比例由高到低排序。
      將這三個代號依排序結果換算成字母表順序（A=1…E=5），組成三個數字，作為以下密文的<strong>逐字位移金鑰</strong>
    ...
    hints: [
      "先確認 A–E 誰是硬組織、誰是軟組織。",
      "有三種組織的無機質比例都有明顯數字、呈現高低梯度，是哪三種？把它們依比例由高到低排序。",
  ...
  },
  {
    ...
    background: `
      <p>咀嚼時實際出力的肌肉稱為「咀嚼肌」，主要有四塊：顳肌、咬肌、翼內肌、翼外肌，它們與下頜骨、顳骨共同構成顳顎關節（TMJ），是下頜運動的樞紐。</p>
      <p>支配臉部與口腔感覺的主要神經是三叉神經，分成三大分支：眼分支（V1，管額頭眼周）、上頜分支（V2，管上排牙齒與上顎）、
      下頜分支（V3，是唯一同時具有感覺與運動功能的分支，負責下排牙齒感覺，也支配所有咀嚼肌的運動）。</p>
    `,
    task: `
      <table class="data-table">
        <thead><tr><th>代號</th><th>功能描述</th></tr></thead>
        <tbody>
          <tr><td>A</td><td>起自顳窩，止於下頜骨冠突，主要功能為上提下頜骨（閉口）及後退下頜骨</td></tr>
          <tr><td>B</td><td>起自顴弓，止於下頜角外側，咀嚼力量最大的肌肉之一，主要功能為上提下頜骨</td></tr>
          <tr><td>C</td><td>與咬肌合力形成肌肉吊帶，協助上提下頜骨</td></tr>
          <tr><td>D</td><td>唯一在張口時收縮的咀嚼肌，牽引下頜骨向前並協助張口</td></tr>
          <tr><td>E</td><td>連接下頜骨髁突與顳骨關節窩的關節，是下頜運動的樞紐</td></tr>
          <tr><td>F</td><td>三叉神經分支，感覺分布於額頭、眼睛周圍，不支配牙齒</td></tr>
          <tr><td>G</td><td>三叉神經分支，負責上排牙齒與上顎的感覺</td></tr>
          <tr><td>H</td><td>三叉神經分支，唯一同時具有感覺與運動功能，負責下排牙齒感覺，也支配所有咀嚼肌的運動</td></tr>
        </tbody>
      </table>
      <p>八個代號裡，有一組屬於「咀嚼肌」，有一個是唯一「同時支配下排牙齒感覺與咀嚼肌運動」的神經分支。找出它們，就能得到兩個驗證碼。</p>
    `,
    format: "pair",
    inputLabels: ["驗證碼（一）", "驗證碼（二）"],
    answer: ["10", "8"],
  ...
  },
  {
    ...
    task: `
      ...
      <p>假設把這 3 次點心改成「一次全部吃完」，只會觸發一次 Stephan 曲線。危險時間會增加、減少，還是不變？背後的原因可以用背景知識裡的哪一個詞來說明？把這個關鍵詞的字數，作為第二個驗證碼。</p>
    `,
    format: "pair",
    inputLabels: ["驗證碼（一）", "驗證碼（二）"],
    answer: ["61", "2"],
  ...
  },
  {
    ...
    background: `
      ...
      <ul>
        <li><strong>健康</strong>：探測深度 &lt; 3mm，探測不出血</li>
        <li><strong>齦炎</strong>：探測深度 3–4mm，探測容易出血，但<strong>沒有</strong>齒槽骨與附連組織的破壞（可逆狀態）</li>
        <li><strong>牙周炎</strong>：探測深度 ≥ 4mm，且合併<strong>附連組織喪失</strong>，屬於不可逆的破壞</li>
      </ul>
    `,
    task: `
      ...
      <tr><td>出血</td><td colspan="6">全部有</td></tr><tr><td>附連組織喪失</td><td colspan="6">全部有</td></tr></tbody></table>
      <p>依照背景知識的判定標準，判斷牙齒①②③各自屬於「健康／齦炎／牙周炎」。這三顆牙的判定結果裡，藏著兩個驗證碼——
      一個和「不可逆」的那個等級有多少測量點有關，另一個和「哪幾顆牙不可逆」在序列中的位置有關。下方是非題可以幫你確認判斷邏輯是否正確。</p>
  ...
  },
  {
    ...
    background: `
      <p>常見的牙科修復材料各有優缺點：</p>
      <ul>
        <li><strong>複合樹脂</strong>：與牙齒顏色相近、美觀度高，需酸蝕與黏合劑黏著，適合前牙美觀修復，耐磨耗度中等。</li>
        <li><strong>銀汞合金</strong>：耐用、抗壓強度高、價格便宜，但顏色為銀灰色不美觀，現今臨床使用已逐漸減少。</li>
        <li><strong>牙科陶瓷</strong>：美觀度最高、生物相容性佳，但材質偏脆、價格較高，多用於牙冠、貼片等修復。</li>
        <li><strong>玻璃離子水門汀</strong>：可持續釋放氟離子、有助預防蛀牙，但機械強度較弱，常用於乳牙或暫時性填補。</li>
      </ul>
    `,
    task: `
      <table class="data-table">
  ...
  },
  {
    ...
    background: `
      ...
      <ul>
        ...
        <li>牙根表面的<strong>牙周韌帶細胞</strong>是否存活，是再植成功與否的關鍵；離體時間越短、保存介質越適當，成功率越高。</li>
