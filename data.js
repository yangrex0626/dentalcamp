...
------------------------------------------------------------------- */
const EMAILJS_PUBLIC_KEY = "T9cBNk_a4YRGa1wbU";
const EMAILJS_SERVICE_ID = "service_pd77cjg";
const EMAILJS_TEMPLATE_ID = "template_gjd8pv5";
...
const STAGES = [
  {
    ...
    `,
    task: `
      <p>找出三種胚胎構造最終發育成的「主要組織」——成釉器 → ？　牙乳頭 → ？（取主要負責硬組織形成者）　牙囊 → ？（取最主要的硬組織），會給你第一個數字。</p>
      <p>將下列 8 顆牙齒依萌發年齡「由小到大」重新排序：乳第二大臼齒（約26個月）、第一恆臼齒／六歲齒（約6歲）、
      乳犬齒（約18個月）、第三大臼齒／智齒（約18歲）、下顎乳正中門齒（約6個月）、第二恆臼齒／十二歲齒（約12歲）、
      乳第一大臼齒（約14個月）、下顎恆正中門齒（約6.5歲）。背景知識中特別點名的那顆牙，在排序中的位置，會給你第二個數字。</p>
    `,
    format: "pair",
    inputLabels: ["驗證碼（一）", "驗證碼（二）"],
    answer: ["12", "5"],
    hints: [
      "牙乳頭分化出兩種組織，一種是硬組織、一種是含血管神經的軟組織——先確認哪一個才是硬組織。牙囊分化出三種構造，其中哪一個才算「牙齒本身」的硬組織（不是齒槽骨）？",
      "確認三個組織的正確英文名稱後，取每個字的第一個字母，查它在 26 個字母表中的序位，三個數字相加就是第一個驗證碼。",
      "三個組織依序是 Enamel、Dentin、Cementum，開頭字母序位是 5、4、3。",
      "把八顆牙依萌發年齡排序後，六歲齒（第一恆臼齒）前面還有幾顆牙？"
    ],
    story: `
  ...
  },
  {
    ...
    background: `
      <p>牙齒可依型態與功能分成四大類：</p>
      <ul>
        <li><strong>門齒（切齒，Incisor）</strong>：切端呈鑿狀，單根，負責切斷食物；下顎的正中門齒通常是恆牙中最早萌發的門齒，比同側的側門齒更早長出</li>
        <li><strong>犬齒（Canine）</strong>：牙尖尖銳呈單一尖峰，牙根是全口最長的，負責撕裂食物</li>
        <li><strong>小臼齒（Premolar）</strong>：咬合面通常有 2 個咬頭，介於犬齒與大臼齒之間；第一小臼齒緊鄰犬齒之後，牙根常分為頰側、舌側兩根，第二小臼齒則緊鄰第一大臼齒之前，通常只有一個牙根</li>
      ...
      <p><strong>象限（恆牙）</strong>：1=右上、2=左上、3=左下、4=右下　　<strong>牙位</strong>：1=正中門齒、2=側門齒、3=犬齒、4=第一小臼齒、5=第二小臼齒、6=第一大臼齒、7=第二大臼齒、8=第三大臼齒（智齒）</p>
      <p>例如：右上顎的犬齒 → 象限1、牙位3 → FDI 代碼 <strong>13</strong></p>
      <div class="fdi-chart">
        <div class="fdi-row">
          <div class="fdi-quadrant">
            <div class="fdi-label">右上（象限 1）</div>
            <div class="fdi-teeth">
              <span>18</span><span>17</span><span>16</span><span>15</span><span>14</span><span>13</span><span>12</span><span>11</span>
            </div>
          </div>
          <div class="fdi-mid"></div>
          <div class="fdi-quadrant">
            <div class="fdi-label">左上（象限 2）</div>
            <div class="fdi-teeth">
        ...
        <div class="fdi-row">
          <div class="fdi-quadrant">
            <div class="fdi-label">右下（象限 4）</div>
            <div class="fdi-teeth">
          ...
          <div class="fdi-mid"></div>
          <div class="fdi-quadrant">
            <div class="fdi-label">左下（象限 3）</div>
            <div class="fdi-teeth">
              <span>31</span><span>32</span><span>33</span><span>34</span><span>35</span><span>36</span><span>37</span><span>38</span>
            </div>
          </div>
        </div>
        <div class="fdi-note">圖為由外朝內看向病患口腔的排列方式：病患的右側對應圖面左側。個位數 1→8 由正中線往後數（門齒→門齒→犬齒→小臼齒→小臼齒→大臼齒→大臼齒→大臼齒）。</div>
      </div>
    `,
    task: `
      ...
      <ol>
        ...
        <li>左上顎、咬合面有 2 個咬頭、介於犬齒與大臼齒之間、牙根分為頰側與舌側兩根</li>
      </ol>
    ...
    answer: ["10", "14"],
    hints: [
      "先判斷每段描述是門齒、犬齒、小臼齒還是大臼齒，再對照描述裡的方位決定象限。",
      "門齒是 1 或 2（正中門齒／側門齒）、犬齒是 3、小臼齒是 4 或 5、大臼齒是 6／7／8。",
      "牙根分頰側、舌側兩根的小臼齒，通常是緊鄰犬齒的第一小臼齒（4），不是第二小臼齒（5）。",
      "四個 FDI 代碼的十位數（象限）加起來是第一個驗證碼，個位數（牙位）加起來是第二個驗證碼。"
    ],
    story: `
      型態鑑定比對完成，四顆牙齒的位置被準確標出。報告邊緣有一行紅字批註：<br>
      <em>「其中一顆恆牙——右上正中門齒——半年前有過外傷紀錄，需另行追蹤。」</em><br>
  ...
  },
  {
    ...
    background: `
      ...
      <ul>
        ...
        <li><strong>牙骨質（Cementum）</strong>：包覆牙根表面，讓牙周韌帶纖維附著，礦物質含量介於牙本質與軟組織之間，正常範圍約在 40–50% 之間。</li>
    ...
    task: `
      ...
      金鑰的三個數字依序循環套用在密文的每一個英文字母上（第 1 個字母位移金鑰第 1 個數字、第 2 個字母位移金鑰第 2 個數字……數到第 4 個字母時再從金鑰第 1 個數字重新開始）。
      位移方式是把字母在 26 個字母表中的位置往後移動指定的格數（超過 Z 就繞回 A 繼續數）。</p>
      ...
      <div class="cipher-block">UIAGRTPIJKKMVJTWV</div>
    `,
    format: "single",
    ...
    hints: [
      ...
      "背景知識有給牙骨質無機質比例的正常範圍（40–50%），兩個數值相近的候選代號裡，哪一個超出了這個範圍？超出的那個就是要排除的樣本。",
      "排除掉那個代號後，剩下的組織裡有三種呈現明顯的礦物質梯度，把它們依比例由高到低排序。",
      "把排序後的三個組織代號，換算成字母在 26 個字母表中的順序，那就是金鑰的三個數字。",
      "密文裡沒有藏數字，答案是解密後、用英文單字拼出來的數字；解密方法可以參考題目裡的範例。"
    ],
    story: `
      密文解開：<em>「SEVEN ONE EIGHT FOUR」</em>。組織密碼破解成功，
  ...
  },
  {
    ...
    answer: ["10", "8"],
    hints: [
      "A–D 的描述都在說某塊肌肉如何移動下頜骨，E 在描述一個關節，F–H 在描述神經受損後的症狀——先把八個代號分成這三組。",
      "F–H 三個症狀描述裡，只有一個同時提到「感覺喪失」和「肌肉無法收縮」兩種症狀，那才是同時具有感覺和運動功能的分支。",
      "找到咀嚼肌的四個代號和神經分支的那個代號，換算成字母序位——咀嚼肌四個代號加總是第一個驗證碼，神經分支代號的序位就是第二個驗證碼。"
    ],
    story: `
  ...
  },
  {
    ...
    hints: [
      ...
      "連續低於 5.5 的區間是從第 3 分鐘到第 64 分鐘，總共 61 分鐘；單次進食的危險期是 24 − 3 = 21 分鐘。"
    ],
    story: `
  ...
  },
  {
    ...
    background: `
      ...
      <div class="depth-scale">
        <div class="depth-zone healthy"><span class="depth-range">&lt; 3mm</span><span class="depth-label">健康</span></div>
        <div class="depth-zone gingivitis"><span class="depth-range">3–4mm</span><span class="depth-label">齦炎（可逆）</span></div>
        <div class="depth-zone periodontitis"><span class="depth-range">≥ 4mm ＋ 附連組織喪失</span><span class="depth-label">牙周炎（不可逆）</span></div>
      </div>
    `,
    task: `
  ...
  },
  {
    ...
    task: `
      ...
      <p>算出每一項飲品的 pH 值，篩出真正屬於「高風險」的品項，再依酸性強弱排出順序，把編號依序串接成一組密碼。</p>
    `,
    format: "single",
    inputLabels: ["驗證碼"],
    answer: ["1324"],
